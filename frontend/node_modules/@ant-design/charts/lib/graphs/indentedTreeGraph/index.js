...
var IndentedTreeGraph = function (props) {
    var data = props.data, className = props.className, style = props.style, width = props.width, height = props.height, _a = props.nodeType, nodeType = _a === void 0 ? 'card' : _a, _b = props.edgeType, edgeType = _b === void 0 ? 'cubic-horizontal' : _b, _c = props.behaviors, behaviors = _c === void 0 ? ['zoom-canvas', 'drag-canvas'] : _c, _d = props.nodeAnchorPoints, nodeAnchorPoints = _d === void 0 ? constants_1.defaultNodeAnchorPoints : _d, _e = props.nodeSize, nodeSize = _e === void 0 ? constants_1.defaultNodeSize : _e, layout = props.layout, _f = props.animate, animate = _f === void 0 ? true : _f, nodeStyle = props.nodeStyle, edgeStyle = props.edgeStyle, edgeCfg = props.edgeCfg, markerStyle = props.markerStyle, _g = props.markerPosition, markerPosition = _g === void 0 ? 'right' : _g, _h = props.nodeStateStyles, nodeStateStyles = _h === void 0 ? constants_1.defaultStateStyles : _h, _j = props.edgeStateStyles, edgeStateStyles = _j === void 0 ? constants_1.defaultStateStyles : _j, _k = props.collapseExpand, collapseExpand = _k === void 0 ? true : _k, titleStyle = props.titleStyle, bodyStyle = props.bodyStyle, footerStyle = props.footerStyle, footerValueStyle = props.footerValueStyle, _l = props.showArrow, showArrow = _l === void 0 ? true : _l, _m = props.arrowType, arrowType = _m === void 0 ? 'vee' : _m, _o = props.autoFit, autoFit = _o === void 0 ? true : _o, onReady = props.onReady, loading = props.loading, loadingTemplate = props.loadingTemplate, errorTemplate = props.errorTemplate;
